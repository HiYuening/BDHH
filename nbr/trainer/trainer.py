...
class NBRTrainer:
    def __init__(self, corpus, max_epochs, topk, early_stop_num,dataset_name='dunnhumby'):
        self.corpus = corpus
        ...
        self.train_dataloader=DataLoader(self.dev_dataset, batch_size=1, collate_fn=eval_collate_fn)
        ...
        if dataset_name == 'dunnhumby':
            n_node = 23194
            n_price = 11
            n_category = 301
        elif dataset_name == 'digineticaBuy':
            n_node = 24889
            n_price = 100
            n_category = 721
        ...
        for batch in self.train_dataloader:
            self.train_matrix = Data(self.train_dataset, shuffle=True, n_node=n_node, n_price=n_price, n_category=n_category)
        self.dev_matrix = Data(self.dev_dataset, shuffle=True, n_node=n_node, n_price=n_price, n_category=n_category)
        self.test_matrix = Data(self.test_dataset, shuffle=True, n_node=n_node, n_price=n_price, n_category=n_category)
